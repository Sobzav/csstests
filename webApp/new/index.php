...
<head>
    ...
    <svg style="display:none;">
        ...
        <path d="M12 11.293l10.293-10.293.707.707-10.293 10.293 10.293 10.293-.707.707-10.293-10.293-10.293 10.293-.707-.707 10.293-10.293-10.293-10.293.707-.707 10.293 10.293z" stroke="black" stroke-width="1" stroke-dasharray="0" />
        </symbol>
    </svg>
</head>
                ...
                <div class="item-1">
                    ...
                    <div class="form-acc-head">
                        <div class="grid-head-7x1">
                            ...
                            <div class="div5"> <button class="x-but"><svg width="14px" height="14px" aria-hidden="true">
                                        <use xlink:href="#x-but"></use>
                                    </svg></button></div>
                            <!-- кнопка крестик -->
                        </div>
                    </div>
                    ...
                    <div class="form-container">
                        ...
                        <div class="form-acc">
                            <div class="grid--7x2">
                                ...
                                <!-- ТИП -->
                                <div class="div4">
                                    <div class="dropdown wide-100" tabindex="0"><input class="mainInput"><button
                                            class="dropbtn"><svg width="16px" height="16px" aria-hidden="true">
                                ...
                                <!-- кнопка крестик -->
                                <div class="div6"> <button class="x-but"><svg width="14px" height="14px"
                                            aria-hidden="true">
                                            <use xlink:href="#x-but"></use>
                                        </svg></button>
                                </div>
                                ...
                                <div class="div8"> <label>Игнорировать активность
                                    </label> <input type="checkbox" id="" name="" value=""></div><!-- ТРЕТИЙ -->
                        ...
                        <div class="form-acc">
                            ...
                            <div class="grid--5x2">
                                ...
                                <div class="div6">
                                    ...
                                    <ul>
                                        <li><input type="checkbox" id="" name="" value=""><label>Разрешенные
                                            ...
                                            <ol>
                                                <li>
                                                    <div class="dropdown wide-100" tabindex="0"><input
                                                            class="mainInput"><button class="dropbtn"><svg width="16px"
                                                                height="16px" aria-hidden="true">
                                                                <use xlink:href="#down"></use>
                                                            </svg></button>
                                                        <button class="x-but"><svg width="10px" height="10px"
                                                                aria-hidden="true">
                                                                <use xlink:href="#x-but"></use>
                                                            </svg></button></div>
                                                </li>
                                                ...
                                                <li class="unordered-item-button"><button class="plus-button"><span><svg
                                ...
                                <div class="div7">
                                    ...
                                    <ol>
                                        <li>
                                            <div><input type="checkbox" class="green" id="" name="" value=""><button
                                                    class="x-but"><svg width="10px" height="10px" aria-hidden="true">
                                                        <use xlink:href="#x-but"></use>
                                                    </svg></button></div>
                                            <div class="dropdown wide-100" tabindex="0"><input class="mainInput"><button
                                                    class="dropbtn"><svg width="16px" height="16px" aria-hidden="true">
                                        ...
                                        <li class="unordered-item-button">
                                            <button class="plus-button"><span><svg width="8px" height="8px"
                                                        aria-hidden="true" transform='rotate(45)'>
                                                        <use xlink:href="#x-but"></use>
                                                    </svg></span></button>
                                        </li>
                                    </ol>
                                ...
                                <div class="div8">
                                    <ul>
                                        <li><label>Понедельник</label> <input type="text" disabled="" value="с"><input type="text" maxlength="2"
                                                value="09" onkeypress="return isHour(event)"><input type="text" disabled="" value=":"><input type="text" maxlength="2" value="22">
                                            <input type="text" disabled="" value="до"><input type="text" maxlength="2" value="22"><input
                                                type="text" value=":"><input type="text" value="56"> <input
                                                type="checkbox" id="" name="" value="">
                                        </li>
                                        <li><label>Вторник</label> <input type="text" disabled="" value="с"><input type="text" maxlength="2"
                                                value="09"><input type="text" disabled="" value=":"><input type="text" maxlength="2" value="22">
                                            <input type="text" disabled="" value="до"><input type="text" maxlength="2" value="22"><input
                                                type="text" value=":"><input type="text" value="56"> <input
                                                type="checkbox" id="" name="" value="">
                                        </li>
                                        <li><label>Среда</label> <input type="text" disabled="" value="с"><input type="text" maxlength="2"
                                                value="09"><input type="text" disabled="" value=":"><input type="text" maxlength="2" value="22">
                                            <input type="text" disabled="" value="до"><input type="text" maxlength="2" value="22"><input
                                                type="text" value=":"><input type="text" value="56"> <input
                                                type="checkbox" id="" name="" value=""></li>
                                        <li><label>Четверг</label> <input type="text" disabled="" value="с"><input type="text" maxlength="2"
                                                value="09"><input type="text" disabled="" value=":"><input type="text" maxlength="2" value="22">
                                            <input type="text" disabled="" value="до"><input type="text" maxlength="2" value="22"><input
                                                type="text" value=":"><input type="text" value="56"> <input
                                                type="checkbox" id="" name="" value="">
                                        </li>
                                        <li><label>Пятница</label> <input type="text" disabled="" value="с"><input type="text" maxlength="2"
                                                value="09"><input type="text" disabled="" value=":"><input type="text" maxlength="2" value="22">
                                            <input type="text" disabled="" value="до"><input type="text" maxlength="2" value="22"><input
                                                type="text" value=":"><input type="text" value="56"> <input
                                                type="checkbox" id="" name="" value="">
                                        </li>
                                        <li><label>Суббота</label> <input type="text" disabled="" value="с"><input type="text" maxlength="2"
                                                value="09"><input type="text" disabled="" value=":"><input type="text" maxlength="2" value="22">
                                            <input type="text" disabled="" value="до"><input type="text" maxlength="2" value="22"><input
                                                type="text" value=":"><input type="text" value="56"> <input
                                                type="checkbox" id="" name="" value="">
                                        </li>
                                        <li><label>Воскресенье</label> <input type="text" disabled="" value="с"><input type="text" maxlength="2"
                                                value="09"><input type="text" disabled="" value=":"><input type="text" maxlength="2" value="22">
                                            <input type="text" disabled="" value="до"><input type="text" maxlength="2" value="22"><input
                                                type="text" value=":"><input type="text" value="56"> <input
                                                type="checkbox" id="" name="" value="">
