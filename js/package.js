...
class PackageSimple {
    ...
    setSize(
        ...
        console.groupCollapsed("class PackageSimple.setSize { id=%o; wx=%o; wy=%o; wh=%o; force=%o", this._id, wx, wy, h, force);
        ...
        if ((this._wx != wx) || (this._wy != wy) || (this._h != h) || force) {
            ...
            console.log("id = %i, wx = %i, wy = %i, h = %i", this._id, this._wx, this._wy, this._h);
        }
...
class PackageContainerItem extends PackageSimple {
    ...
    setSize(
        ...
        console.groupCollapsed("class PackageContainerItem.setSize { id=%o; wx=%o; wy=%o; wh=%o; force=%o", this._id, wx, wy, h, force);
        ...
        if ((this._wx != wx) || (this._wy != wy) || (this._h != h) || force) {
            ...
            console.log("wx=" + this._wx  + " wy=" + this._wy + " h=" + this._h);
        }
        console.groupEnd();
    }
                    ...
                    if (this.item[rowIndex].length > 0) {
                        ...
                        for (var colIndex = 0; colIndex < this.item[rowIndex].length; colIndex++) {
                            ...
                            if (typeof this.item[rowIndex][colIndex] !== undefined) {
                                ...
                                console.log("item[%i][%i]: %o", rowIndex, colIndex, this.item[rowIndex][colIndex]);    
