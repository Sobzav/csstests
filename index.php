...
<head>
    ...
    <!-- <link rel="stylesheet" href="http://172.17.17.92/webapp/css/style.css"> -->
...
<body class="">
    ...
    <script src="http://172.17.17.92/webapp/package/main.js"></script>
                    ...
                    <section class="section-subs">
                        ...
                        <section class="section-sub">
                            ...
                            <div class="section-sub__grid">
                                ...
                                <div class="section-sub__grid--5x2">
                                    <div class="nmbr"><label class="ml-1 my-1" id="sub1"> 1. </label></div>
                                    <div class="frst">
                                    ...
                                    <div class="scnd inputBlock mx-4">
                                    ...
                                    <div class="thrd inputBlock mx-2">
                                        <label class="" for="selCode1"> </label>
                                    ...
                                    <!-- Second grid Line -->
                                    <div class="ffth inputBlock ml-8 mr-2">
                                        <label class="inputLabel multyLine" for="inpNy1"> Количество<br>по вертикали </label>
                                        <input class="" size="1" type="text" id="inpNy1" name="package_wy1">
                                        <label class="" for="inpNy1"> шт </label>
                                    </div>

                                    <div class="sxth inputBlock mx-4">
                                        <label class="inputLabel multyLine" for="inpNx1"> Количество<br>по горизонтали </label>
                                        <input class="" size="1" type="text" id="inpNx1" name="package_wx1">
                                        <label class="" for="inpNx1"> шт </label>
                                    </div>

                                    <div class="svnth inputBlock-base ml-10">
                        ...
                        <section class="section-sub">
                            ...
                            <div class="flex flex-row mt-2">
                                ...
                                <div class="inputBlock mx-2">
                                    <label class="" for="selCode2"> </label>
                            ...
                            <div class="flex flex-row mb-3 mt-1">
                                ...
                                <div class="inputBlock ml-8 mr-2">
                                    <label class="inputLabel multyLine" for="inpNy2"> Количество<br>по вертикали </label>
                                    <input class="" size="1" type="text" id="inpNy2" name="package_wx2">
                                    <label class="" for="inpNy2"> шт </label>
                                </div>

                                <div class="inputBlock mx-4">
                                    <label class="inputLabel multyLine" for="inpNx2"> Количество<br>по горизонтали </label>
                            ...
                            <div class="flex flex-row mb-3 mt-1">
                                ...
                                <div class="inputBlock ml-8 mr-2">
                                    <label class="inputLabel multyLine" for="inpNy3"> Количество<br>по вертикали </label>
                                    <input class="" size="1" type="text" id="inpNy3" name="package_wx3">
                                    <label class="" for="inpNy3"> шт </label>
                                </div>

                                <div class="inputBlock mx-4">
                                    <label class="inputLabel multyLine" for="inpNx3"> Количество<br>по горизонтали </label>
                        ...
                        <section class="section-sub">
                            ...
                            <div class="flex flex-row mb-2 mt-1">
                                ...
                                <div class="inputBlock ml-8 mr-2">
                                    <label class="inputLabel multyLine" for="inpNy4"> Количество<br>по вертикали </label>
                                    <input class="" size="1" type="text" id="inpNy4" name="package_wx4">
                                    <label class="" for="inpNy4"> шт </label>
                                </div>

                                <div class="inputBlock mx-4">
                                    <label class="inputLabel multyLine" for="inpNx4"> Количество<br>по горизонтали </label>
