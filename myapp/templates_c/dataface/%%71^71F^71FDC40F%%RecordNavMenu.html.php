...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', 'RecordNavMenu.html', 54, false),array('modifier', 'urlencode', 'RecordNavMenu.html', 76, false),array('modifier', 'escape', 'RecordNavMenu.html', 190, false),array('block', 'translate', 'RecordNavMenu.html', 150, false),)), $this); ?>
...
')" />&nbsp;
		<?php echo ((is_array($_tmp=$this->_tpl_vars['relationship']['label'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>

		<ul style="display: none" id="navtree-<?php echo ((is_array($_tmp=$this->_tpl_vars['record']->getId())) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
/<?php echo ((is_array($_tmp=$this->_tpl_vars['relationship']['name'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
">
