...
<h3 class="edit-record-heading">
    <?php $this->_tag_stack[] = array('translate', array('id' => 'Edit Record Form Heading','tablename' => $this->_tpl_vars['tableSingularLabel'],'recordTitle' => $this->_tpl_vars['recordTitle'])); $_block_repeat=true;$this->_plugins['block']['translate'][0][0]->translate($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
        Edit <?php echo ((is_array($_tmp=$this->_tpl_vars['tableSingularLabel'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
 &raquo; <?php echo ((is_array($_tmp=$this->_tpl_vars['recordTitle'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
...
"><?php echo ((is_array($_tmp=$this->_tpl_vars['tab']['label'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
        ...
        <script language="javascript">
            ...
            css.type='text/css';
            css.rel='stylesheet';
            css.href='<?php echo ((is_array($_tmp=$this->_tpl_vars['ENV']['DATAFACE_URL'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'javascript') : smarty_modifier_escape($_tmp, 'javascript')); ?>
/css/jquery.tabs.css';
