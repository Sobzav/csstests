<?php /* Smarty version 2.6.18, created on 2019-12-03 13:13:08
...
>
 ...
 <?php if ($this->_tpl_vars['element']['field']['display'] == 'block'): ?>colspan="2" class="Dataface_QuickForm-textarea-label-cell Dataface_QuickForm-block-label-cell"<?php endif; ?> valign="top" <?php if ($this->_tpl_vars['element']['field']['display'] != 'block'): ?>align="right" class="Dataface_QuickForm-label-cell"<?php endif; ?>>
						<div class="field <?php if ($this->_tpl_vars['element']['error']): ?>error<?php endif; ?>" id="<?php echo ((is_array($_tmp=$this->_tpl_vars['element']['field']['tablename'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
-<?php echo $this->_tpl_vars['element']['field']['name']; ?>
-label-wrapper">
							
							<label for="<?php echo ((is_array($_tmp=$this->_tpl_vars['element']['field']['name'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
">
...
" <?php endif; ?>class="field-label-link no-link-icon"><?php endif; ?>
									<?php echo ((is_array($_tmp=$this->_tpl_vars['element']['field']['widget']['label'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
...
-wrapper">
						...
						<?php if ($this->_tpl_vars['element']['properties']['preview']): ?>
							<div id="<?php echo ((is_array($_tmp=$this->_tpl_vars['element']['field']['tablename'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
-<?php echo ((is_array($_tmp=$this->_tpl_vars['element']['field']['name'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
-preview">
								...
								<?php if ($this->_tpl_vars['element']['properties']['image_preview']): ?>
									...
									<img src="<?php echo ((is_array($_tmp=$this->_tpl_vars['element']['properties']['image_preview'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
...
"<?php endif; ?> class="field-label-link no-link-icon"><?php endif; ?>
															<?php echo ((is_array($_tmp=$this->_tpl_vars['groupel']['field']['widget']['label'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
...
<?php endif; ?>
							...
							<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo $this->_plugins['block']['define_slot'][0][0]->define_slot($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>
								...
								require('<?php echo ((is_array($_tmp=$this->_tpl_vars['ENV']['DATAFACE_URL'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'javascript') : smarty_modifier_escape($_tmp, 'javascript')); ?>
/js/ajax.js');
...
'));
							...
							<?php if ($this->_tpl_vars['element']['properties']['link']): ?>
								<a href="<?php echo ((is_array($_tmp=$this->_tpl_vars['element']['properties']['link'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
">Go</a>
							<?php endif; ?>
