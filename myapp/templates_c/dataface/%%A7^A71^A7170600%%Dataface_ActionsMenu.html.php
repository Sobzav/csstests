...
" <?php endforeach; endif; unset($_from); ?>
                ...
                <a <?php if ($this->_tpl_vars['action']['subactions']): ?>onclick="return false;" <?php endif; ?>class="<?php if ($this->_tpl_vars['action']['subactions']): ?>trigger<?php endif; ?>" id="<?php echo $this->_tpl_vars['id_prefix']; ?>
...
" <?php endforeach; endif; unset($_from); ?>
							  >
								<a <?php if ($this->_tpl_vars['subaction']['subactions']): ?>onclick="return false;" <?php endif; ?>class="<?php if ($this->_tpl_vars['subaction']['subactions']): ?>trigger horizontal-trigger<?php endif; ?>" id="<?php echo $this->_tpl_vars['id_prefix']; ?>
