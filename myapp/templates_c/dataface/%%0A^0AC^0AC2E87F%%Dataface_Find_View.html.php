<?php /* Smarty version 2.6.18, created on 2019-12-03 12:33:51
         compiled from Dataface_Find_View.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'use_macro', 'Dataface_Find_View.html', 20, false),array('block', 'fill_slot', 'Dataface_Find_View.html', 21, false),array('block', 'translate', 'Dataface_Find_View.html', 22, false),array('block', 'define_slot', 'Dataface_Find_View.html', 24, false),array('function', 'block', 'Dataface_Find_View.html', 23, false),array('function', 'search_form', 'Dataface_Find_View.html', 25, false),)), $this); ?>
...
<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo $this->_plugins['block']['translate'][0][0]->translate($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?></div><?php endif; ?>
		<?php echo $this->_plugins['function']['block'][0][0]->block(array('name' => 'before_find_form'), $this);?>

		<?php $this->_tag_stack[] = array('define_slot', array('name' => 'find_form')); $_block_repeat=true;$this->_plugins['block']['define_slot'][0][0]->define_slot($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
		<?php echo $this->_plugins['function']['search_form'][0][0]->search_form(array(), $this);?>
		...
		<?php echo $this->_plugins['function']['block'][0][0]->block(array('name' => 'after_find_form'), $this);?>
