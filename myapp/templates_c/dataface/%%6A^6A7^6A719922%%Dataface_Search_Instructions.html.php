...
smarty_core_load_plugins(array('plugins' => array(array('function', 'block', 'Dataface_Search_Instructions.html', 1, false),array('block', 'define_slot', 'Dataface_Search_Instructions.html', 2, false),array('block', 'translate', 'Dataface_Search_Instructions.html', 5, false),array('modifier', 'escape', 'Dataface_Search_Instructions.html', 8, false),)), $this); ?>
...
<h2 class="advanced-search-heading"><?php echo ((is_array($_tmp=$this->_tpl_vars['tableLabel'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
 &raquo; <?php $this->_tag_stack[] = array('translate', array('id' => "actions.find.advanced_search_heading")); $_block_repeat=true;$this->_plugins['block']['translate'][0][0]->translate($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Какойта поиск<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo $this->_plugins['block']['translate'][0][0]->translate($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?></h2>
...
<?php $this->_tag_stack[] = array('define_slot', array('name' => 'search_instructions')); $_block_repeat=true;$this->_plugins['block']['define_slot'][0][0]->define_slot($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
	...
	<div class="accordion search-instruction-items">
		<?php echo $this->_plugins['function']['block'][0][0]->block(array('name' => 'before_search_instruction_items'), $this);?>
