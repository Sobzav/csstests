<?php /* Smarty version 2.6.18, created on 2019-12-03 12:33:51
         compiled from Dataface_FindForm.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'block', 'Dataface_FindForm.html', 115, false),array('block', 'define_slot', 'Dataface_FindForm.html', 116, false),array('block', 'collapsible_sidebar', 'Dataface_FindForm.html', 191, false),array('modifier', 'escape', 'Dataface_FindForm.html', 117, false),array('modifier', 'count', 'Dataface_FindForm.html', 141, false),)), $this); ?>
...
?>
	...
	<tr id="<?php echo ((is_array($_tmp=$this->_tpl_vars['element']['field']['name'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
_findform_row">
		<td valign="top" align="right" class="Dataface_QuickForm-label-cell Dataface_FindForm-label-cell">
		<div class="field" id="findform_<?php echo ((is_array($_tmp=$this->_tpl_vars['element']['field']['tablename'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
...
-label-wrapper">
			...
			<label><?php echo ((is_array($_tmp=$this->_tpl_vars['element']['field']['widget']['label'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</label>
		
		</div>
		</td>
		<td class="Dataface_QuickForm-widget-cell Dataface_FindForm-widget-cell">
		<div class="field" id="<?php echo ((is_array($_tmp=$this->_tpl_vars['element']['field']['tablename'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
-<?php echo ((is_array($_tmp=$this->_tpl_vars['element']['field']['name'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
-wrapper">
