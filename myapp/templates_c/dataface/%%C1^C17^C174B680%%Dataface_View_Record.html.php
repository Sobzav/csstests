...
smarty_core_load_plugins(array('plugins' => array(array('function', 'load_record', 'Dataface_View_Record.html', 21, false),array('function', 'block', 'Dataface_View_Record.html', 26, false),array('function', 'record_view', 'Dataface_View_Record.html', 28, false),array('function', 'record_actions', 'Dataface_View_Record.html', 74, false),array('function', 'glance_list', 'Dataface_View_Record.html', 150, false),array('block', 'use_macro', 'Dataface_View_Record.html', 22, false),array('block', 'fill_slot', 'Dataface_View_Record.html', 25, false),array('block', 'define_slot', 'Dataface_View_Record.html', 27, false),array('block', 'collapsible_sidebar', 'Dataface_View_Record.html', 89, false),array('block', 'translate', 'Dataface_View_Record.html', 349, false),array('modifier', 'escape', 'Dataface_View_Record.html', 30, false),array('modifier', 'count', 'Dataface_View_Record.html', 57, false),)), $this); ?>
<?php if ($this->_tpl_vars['ENV']['resultSet']->found() > 0): ?>
	...
	<?php $this->_tag_stack[] = array('use_macro', array('file' => "Dataface_Record_Template.html")); $_block_repeat=true;$this->_plugins['block']['use_macro'][0][0]->use_macro($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
		...
		<script type="text/javascript" src="<?php echo ((is_array($_tmp=$this->_tpl_vars['ENV']['DATAFACE_URL'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
/js/jquery-ui.packed.js"></script>
